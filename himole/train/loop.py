...
def prepare_model_for_adapter_training(model) -> None:
    """Enable the memory-saving settings required for frozen-base adapter training."""
...
def accumulation_steps(cfg) -> int:
    """Return the number of micro-batches needed for one optimizer update."""
    return max(1, cfg.batch_size // cfg.micro_batch_size)
